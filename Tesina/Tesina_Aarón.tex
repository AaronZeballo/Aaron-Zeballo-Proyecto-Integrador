...
\section{Resultados de las tecnicas de sobremuestreo}
 ...
 Al evaluar la métrica de \textit{Accuracy}, se evidencia que esta se mantiene elevada en todos los escenarios (variando entre el $95\%$ y el $98\%$). Por este motivo, el \textit{Accuracy} fue descartado como metrica para evaluar la eficiencia de sobremuestreo.
 
 En cuanto a la \textit{Precision}, por un lado el método G-SMOTE, gracias a su restricción geométrica limitando la generacion de ejemplos cerca de instancias de la clase mayoritaria al momento del sobremuestreo, resultó ser el más seguro, logrando elevar la \textit{Precision} del Random Forest hasta un $0.86$. En contraparte, la incorporación de la fase de limpieza con ADASYN+ENN demostró una caída en los resultados, eliminando instancias en zonas con las clases mezcladas y provocando una caída generalizada en la \textit{Precision} de todos los modelos.
...
\section{Comparación de datos sinteticos frente a originales}
